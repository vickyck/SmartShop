...
public class RegisterActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private TextInputEditText textInputEditTextPIN;
    ...
    private void postDataToSQLite() {
        ...
        if (!inputValidation.isInputEditTextFilled(textInputEditTextPIN, textInputLayoutPIN, "Enter Valid PIN")) {
            return;
        }
        ...
        if (!databaseHelper.checkUser(textInputEditTextEmail.getText().toString().trim())) {
            ...
            user.setPin(textInputEditTextPIN.getText().toString().trim());
