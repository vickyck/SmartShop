...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    public List<User> getAllUser() {
        ...
        if (cursor.moveToFirst()) {
            do {
                ...
                user.setPin(cursor.getString(cursor.getColumnIndex(COLUMN_USER_PIN)));
    ...
    public boolean findUserByPin(String pin) {
        ...
        // selection criteria
        String selection = COLUMN_USER_PIN + " = ?";
        ...
        /**Cursor cursor = db.query(TABLE_USER, //Table to query
                ...
                null,                      //filter by row groups
                null);                      //The sort order**/
        String query = "SELECT * FROM " + TABLE_USER + " WHERE " + COLUMN_USER_PIN + " LIKE '%" + pin + "%'";
